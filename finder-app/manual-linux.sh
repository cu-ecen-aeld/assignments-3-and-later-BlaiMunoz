...
mkdir rootfs
mkdir -p rootfs/bin rootfs/dev rootfs/etc rootfs/home rootfs/lib  rootfs/lib64 rootfs/proc rootfs/sbin rootfs/sys rootfs/tmp rootfs/usr rootfs/var rootfs/conf
...
# cp $SYSROOT/lib64/ld-2.31.so lib

cp $SYSROOT/lib64/libm.so.6 lib64
# cp $SYSROOT/lib64/libm-2.31.so lib

cp $SYSROOT/lib64/libresolv.so.2 lib64
# cp $SYSROOT/lib64/libresolv-2.31.so lib

cp $SYSROOT/lib64/libc.so.6 lib64
# cp $SYSROOT/lib64/libc-2.31.so lib
